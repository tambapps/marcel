...
public enum TokenType {
  ...
  CLASS, EXTENSION, PACKAGE, EXTENDS, IMPLEMENTS, FINAL, SWITCH, WHEN, NOT_WHEN, THIS, SUPER, DUMBBELL, TRY, CATCH, FINALLY,
  INSTANCEOF, NOT_INSTANCEOF("!instanceof"), THROW, THROWS, CONSTRUCTOR, DYNOBJ, ASYNC, ENUM,
  // visibilities
