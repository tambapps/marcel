...
import com.tambapps.marcel.semantic.symbol.type.annotation.LoadedJavaAnnotation
...
abstract class LoadedJavaType internal constructor(final override val realClazz: Class<*>, final override val genericTypes: List<JavaType>): AbstractJavaType() {
  ...
  override val globalExtendedType: JavaType? get() = (getAnnotation(ExtensionClass::class.javaAnnotationType)?.getAttribute("forClass")?.value as? Class<*>)?.javaType?.takeIf { it != JavaType.Void }
