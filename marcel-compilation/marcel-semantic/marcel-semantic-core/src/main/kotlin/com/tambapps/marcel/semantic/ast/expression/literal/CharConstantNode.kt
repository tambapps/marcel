...
class CharConstantNode(token: LexToken, override val value: Char): com.tambapps.marcel.semantic.ast.expression.AbstractExpressionNode(JavaType.char, token), JavaConstantExpression {
