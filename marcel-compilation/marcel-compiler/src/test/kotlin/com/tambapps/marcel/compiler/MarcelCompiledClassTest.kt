...
class MarcelCompiledClassTest: AbstractCompilerTest() {
  ...
  fun testDefaultParameters() {
    ...
    val result = compiler.compile(marcelClassLoader = marcelClassLoader, text = getResourceText("/compiled_tests/test_function_default_parameters.mcl"), fileName = className)
