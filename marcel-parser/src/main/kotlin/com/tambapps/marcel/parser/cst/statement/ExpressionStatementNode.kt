...
class ExpressionStatementNode(parent: CstNode? = null,
                              val expressionNode: ExpressionNode,
                              tokenStart: LexToken, tokenEnd: LexToken) :
  AbstractStatementNode(parent, tokenStart, tokenEnd) {

    constructor(expressionNode: ExpressionNode): this(expressionNode.parent, expressionNode, expressionNode.tokenStart,
