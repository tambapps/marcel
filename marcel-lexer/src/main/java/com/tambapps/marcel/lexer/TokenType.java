...
public enum TokenType {
  ...
  VALUE_TRUE, VALUE_FALSE, NEW, IMPORT, AS, INLINE, STATIC, FOR, IN, OF, IF, ELSE, NULL, BREAK, CONTINUE, DEF,
...
// type constants
  ...
  // symbols
  // operators
  PLUS, MINUS, DIV, MUL, COMMA, QUESTION_MARK, INCR, DECR, FIND,
  ...
  ARROW, BRACKETS_OPEN, BRACKETS_CLOSE, SQUARE_BRACKETS_OPEN, SQUARE_BRACKETS_CLOSE, LPAR, RPAR, COLON, SEMI_COLON, PIPE,
