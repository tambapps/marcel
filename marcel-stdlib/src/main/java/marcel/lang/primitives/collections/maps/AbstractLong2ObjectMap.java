...
public abstract class AbstractLong2ObjectMap<V> implements Long2ObjectMap<V>, java.io.Serializable {
	...
	public boolean containsKey(final long k) {
	 final Iterator<Entry <V> > i = long2ObjectEntrySet().iterator();
	 while(i.hasNext())
	...
	public static class BasicEntry <V> implements Entry <V> {
	 ...
	 public boolean equals(final Object o) {
	  ...
	  if (o instanceof Long2ObjectMap.Entry) {
	   ...
	   return ( (key) == (e.getLongKey()) ) && java.util.Objects.equals(value, e.getValue());
	  }
	  final Map.Entry<?,?> e = (Map.Entry<?,?>)o;
	  final Object key = e.getKey();
	  if (key == null || !(key instanceof Long)) return false;
	  final Object value = e.getValue();
	  return ( (this.key) == (((Long)(key)).longValue()) ) && java.util.Objects.equals(this.value, (value));
	 }
	 @Override
	 public int hashCode() {
	...
	public abstract static class BasicEntrySet <V> extends AbstractSet<Entry <V> > {
	 ...
	 public boolean remove(final Object o) {
	  ...
	  if (o instanceof Long2ObjectMap.Entry) {
	   final Entry <V> e = (Entry <V>) o;
	   return map.remove(e.getLongKey(), e.getValue());
	  }
	 ...
	 public Spliterator<Entry <V> > spliterator() {
	  return Spliterators.spliterator(
	   iterator(), map.size(), LongSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	 }
	}
	 ...
	 return new AbstractLongSet() {
	   ...
	   public LongIterator iterator() {
	    return new LongIterator () {
	      private final Iterator<Entry <V> > i = AbstractLong2ObjectMap.this.long2ObjectEntrySet().iterator();
	      @Override
	   ...
	   public LongSpliterator spliterator() {
	    return LongSpliterators.asSpliterator(
	     iterator(), AbstractLong2ObjectMap.this.size(), LongSpliterators.SET_SPLITERATOR_CHARACTERISTICS);
	   }
	 ...
	 return new AbstractCollection<V>() {
	   ...
	   public Iterator <V> iterator() {
	    return new Iterator <V>() {
	      private final Iterator<Entry <V> > i = AbstractLong2ObjectMap.this.iterator();
	      @Override
	   ...
	   public Spliterator <V> spliterator() {
	    return Spliterators.spliterator(
	     iterator(), AbstractLong2ObjectMap.this.size(), LongSpliterators.COLLECTION_SPLITERATOR_CHARACTERISTICS);
	   }
	  };
	}
	/** {@inheritDoc} */
	...
	public void putAll(final Map<? extends Long,? extends V> m) {
	 if (m instanceof Long2ObjectMap) {
	  Iterator<Entry <V> > i = ((Long2ObjectMap<V>) m).iterator();
	  while (i.hasNext()) {
