...
@AllArgsConstructor
class UnmodifiableIntList extends AbstractIntList {

  private final IntList base;
  ...
  public IntListIterator listIterator(int index) {
    return new ImmutableIntListIterator(index);
  }
  ...
  private final class ImmutableSpliterator implements IntSpliterator {
    ...
    public ImmutableSpliterator() {
      this(0, UnmodifiableIntList.this.size(), false);
    }
    ...
    private int getWorkingMax() {
      return hasSplit ? max : UnmodifiableIntList.this.size();
    }
    @Override
  ...
  private class ImmutableIntListIterator implements IntListIterator {
    int pos, last = -1;

    ImmutableIntListIterator(int index) {
      pos = index;
    }
    @Override
