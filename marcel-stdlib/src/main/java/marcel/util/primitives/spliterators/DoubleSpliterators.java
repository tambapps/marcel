...
import marcel.util.primitives.Comparators;
...
public final class DoubleSpliterators {
	 ...
	 */
	public static class EmptySpliterator implements DoubleSpliterator , java.io.Serializable, Cloneable {
		private static final long serialVersionUID = 8379247926738230492L;
		private static final int CHARACTERISTICS = SIZED | SUBSIZED;
		protected EmptySpliterator() {}
		@Override
		public boolean tryAdvance(final java.util.function.DoubleConsumer action) { return false; }
		@Deprecated
		@Override
		public boolean tryAdvance(final Consumer<? super Double> action) { return false; }
		@Override
		public DoubleSpliterator trySplit() { return null; }
		@Override
	...
	private static class SingletonSpliterator implements DoubleSpliterator {
		...
		private static final int CHARACTERISTICS = BASE_SPLITERATOR_CHARACTERISTICS
				...
				| DISTINCT | SORTED | IMMUTABLE;
		public SingletonSpliterator(final double element) {
			this(element, null);
		}
		public SingletonSpliterator(final double element, final DoubleComparator comparator) {
	 ...
	 */
	public static DoubleSpliterator singleton(final double element) {
	 ...
	 * @return a spliterator that iterates just over {@code element}.
	 */
	public static DoubleSpliterator singleton(final double element, final DoubleComparator comparator) {
	...
	private static class ArraySpliterator implements DoubleSpliterator {
		...
		public ArraySpliterator(final double[] array, final int offset, final int length, int additionalCharacteristics) {
			this.array = array;
			this.offset = offset;
			this.length = length;
	...
	private static class ArraySpliteratorWithComparator extends ArraySpliterator {
		private final DoubleComparator comparator;
		public ArraySpliteratorWithComparator(final double[] array, final int offset, final int length, int additionalCharacteristics, final DoubleComparator comparator) {
	 ...
	 */
	public static DoubleSpliterator wrap(final double[] array, final int offset, final int length) {
	 ...
	 */
	public static DoubleSpliterator wrap(final double[] array) {
	 ...
	 * @return a spliterator that will iterate over {@code length} elements of {@code array} starting at position {@code offset}.
	 */
	public static DoubleSpliterator wrap(final double[] array, final int offset, final int length, final int additionalCharacteristics) {
		Arrays.ensureOffsetLength(array, offset, length);
	 ...
	 * @return a spliterator that will iterate over {@code length} elements of {@code array} starting at position {@code offset}.
	 */
	public static DoubleSpliterator wrapPreSorted(
			final double[] array, final int offset, final int length, final int additionalCharacteristics, DoubleComparator comparator) {
		Arrays.ensureOffsetLength(array, offset, length);
	 ...
	 */
	public static DoubleSpliterator wrapPreSorted(
			final double[] array, final int offset, final int length, DoubleComparator comparator) {
	 ...
	 */
	public static DoubleSpliterator wrapPreSorted(
			final double[] array, DoubleComparator comparator) {
	...
	private static class SpliteratorWrapper implements DoubleSpliterator {
		...
		public SpliteratorWrapper(final Spliterator<Double> i) {
			this.i = i;
		}
		...
		public boolean tryAdvance(final java.util.function.DoubleConsumer action) {
			Objects.requireNonNull(action);
			return i.tryAdvance(action instanceof Consumer ? (Consumer<? super Double>)action : action::accept);
		}
		@Deprecated
		@Override
		...
		@Override
		public DoubleComparator getComparator() {
			return Comparators.asDoubleComparator(i.getComparator());
		}
		@Override
		public DoubleSpliterator trySplit() {
			Spliterator<Double> innerSplit = i.trySplit();
	...
	private static class SpliteratorWrapperWithComparator extends SpliteratorWrapper {
		...
		public SpliteratorWrapperWithComparator(final Spliterator<Double> i, final DoubleComparator comparator) {
			super(i);
			this.comparator = comparator;
		}
		@Override
	...
	private static class PrimitiveSpliteratorWrapper implements DoubleSpliterator {
		...
		public PrimitiveSpliteratorWrapper(final Spliterator.OfDouble i) {
			this.i = i;
		}
		@Override
		public boolean tryAdvance(final java.util.function.DoubleConsumer action) {
		...
		@Override
		public DoubleSpliterator trySplit() {
			Spliterator.OfDouble innerSplit = i.trySplit();
			if (innerSplit == null) return null;
	...
	private static class PrimitiveSpliteratorWrapperWithComparator extends PrimitiveSpliteratorWrapper {
		final DoubleComparator comparator;
		public PrimitiveSpliteratorWrapperWithComparator(final Spliterator.OfDouble i, final DoubleComparator comparator) {
			super(i);
			this.comparator = comparator;
		}
		@Override
	...
	public static DoubleSpliterator asDoubleSpliterator(final Spliterator i) {
		if (i instanceof DoubleSpliterator) return (DoubleSpliterator )i;
		if (i instanceof Spliterator.OfDouble) return new PrimitiveSpliteratorWrapper ((Spliterator.OfDouble)i);
	 ...
	 */
	@SuppressWarnings({"unchecked","rawtypes"})
	public static DoubleSpliterator asDoubleSpliterator(final Spliterator i, final DoubleComparator comparatorOverride) {
		if (i instanceof DoubleSpliterator) throw new IllegalArgumentException("Cannot override comparator on instance that is already a " + DoubleSpliterator.class.getSimpleName());
		if (i instanceof Spliterator.OfDouble) return new PrimitiveSpliteratorWrapperWithComparator ((Spliterator.OfDouble)i, comparatorOverride);
	 ...
	 */
	public static void onEachMatching(final DoubleSpliterator spliterator, final java.util.function.DoublePredicate predicate, final java.util.function.DoubleConsumer action) {
	 ...
	 */
	public static abstract class AbstractIndexBasedSpliterator implements DoubleSpliterator {
		 ...
		 */
		protected abstract DoubleSpliterator makeForSplit(int pos, int maxPos);
	...
	private static class SpliteratorConcatenator implements DoubleSpliterator {
		private static final int EMPTY_CHARACTERISTICS = SIZED | SUBSIZED;
		...
		private static final int CHARACTERISTICS_NOT_SUPPORTED_WHILE_MULTIPLE = SORTED | DISTINCT;
		...
		public SpliteratorConcatenator(final DoubleSpliterator a[], int offset, int length) {
			this.a = a;
			this.offset = offset;
			this.length = length;
		...
		@Override
		public DoubleComparator getComparator() {
			if (length == 1 && ((characteristics & SORTED) != 0) ) {
				return (DoubleComparator) a[offset].getComparator();
			}
		...
		public DoubleSpliterator trySplit() {
			...
			switch(length) {
				...
				case 1: {
					...
					DoubleSpliterator split = a[offset].trySplit();
				...
				case 2: {
					...
					DoubleSpliterator split = a[offset++];
					--length;
					// assert length == 1;
	 ...
	 */
	public static DoubleSpliterator concat(final DoubleSpliterator ... a) {
	 ...
	 */
	public static DoubleSpliterator concat(final DoubleSpliterator a[], final int offset, final int length) {
	...
	private static class SpliteratorFromIterator implements DoubleSpliterator {
		...
		SpliteratorFromIterator(final DoubleIterator iter, int characteristics) {
			this.iter = iter;
			this.characteristics = BASE_SPLITERATOR_CHARACTERISTICS | characteristics;
			knownSize = false;
		}
		SpliteratorFromIterator(final DoubleIterator iter, long size, int additionalCharacteristics) {
			this.iter = iter;
			knownSize = true;
			this.size = size;
			if ((additionalCharacteristics & CONCURRENT) != 0) {
				this.characteristics = BASE_SPLITERATOR_CHARACTERISTICS | additionalCharacteristics;
			} else {
				this.characteristics = SIZED | SUBSIZED | BASE_SPLITERATOR_CHARACTERISTICS | additionalCharacteristics;
			}
		}
		@Override
		public boolean tryAdvance(final java.util.function.DoubleConsumer action) {
		...
		public DoubleSpliterator trySplit() {
			...
			while (actualSeen < batchSizeEst && iter.hasNext()) {
				batch[actualSeen++] = iter.nextDouble();
				--size;
			}
	...
	private static class SpliteratorFromIteratorWithComparator extends SpliteratorFromIterator {
		private final DoubleComparator comparator;
		SpliteratorFromIteratorWithComparator(final DoubleIterator iter, int additionalCharacteristics, final DoubleComparator comparator) {
			super(iter, additionalCharacteristics | SORTED_CHARACTERISTICS);
			this.comparator = comparator;
		}
		SpliteratorFromIteratorWithComparator(final DoubleIterator iter, long size, int additionalCharacteristics, final DoubleComparator comparator) {
	 ...
	 */
	public static DoubleSpliterator asSpliterator(final DoubleIterator iter, final long size, final int additionalCharacterisitcs) {
	 ...
	 * @return a type-specific {@code Spliterator} that will give the same elements the iterator will return.
	 */
	public static DoubleSpliterator asSpliteratorFromSorted(
			final DoubleIterator iter, final long size, final int additionalCharacterisitcs, final DoubleComparator comparator) {
	 ...
	 */
	public static DoubleSpliterator asSpliteratorUnknownSize(final DoubleIterator iter, final int characterisitcs) {
	 ...
	 * @return a type-specific {@code Spliterator} that will give the same elements the iterator will return.
	 */
	public static DoubleSpliterator asSpliteratorFromSortedUnknownSize(final DoubleIterator iter, final int additionalCharacterisitcs, final DoubleComparator comparator) {
	...
	private static final class IteratorFromSpliterator implements DoubleIterator , DoubleConsumer {
		...
		IteratorFromSpliterator(final DoubleSpliterator spliterator) {
	 ...
	 */
	public static DoubleIterator asIterator(final DoubleSpliterator spliterator) {
