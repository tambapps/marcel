...
public final class LongSpliterators {
	...
	public static class EmptySpliterator implements LongSpliterator , java.io.Serializable, Cloneable {
	 ...
	 @Override
	 public boolean tryAdvance(final LongConsumer action) { return false; }
	 @Deprecated
	 @Override
	...
	private static class SpliteratorWrapper implements LongSpliterator {
	 ...
	 @Override
	 public LongComparator getComparator() {
	  return Comparators.asLongComparator(i.getComparator());
	 }
	 @Override
	 public LongSpliterator trySplit() {
	...
	private static class PrimitiveSpliteratorWrapper implements LongSpliterator {
	 final OfLong i;
	 public PrimitiveSpliteratorWrapper(final OfLong i) {
	  this.i = i;
	 }
	 @Override
	 public boolean tryAdvance(final LongConsumer action) {
	...
	private static class PrimitiveSpliteratorWrapperWithComparator extends PrimitiveSpliteratorWrapper {
	 final LongComparator comparator;
	 public PrimitiveSpliteratorWrapperWithComparator(final OfLong i, final LongComparator comparator) {
	  super(i);
	  this.comparator = comparator;
	 }
	 @Override
	...
	public static LongSpliterator asLongSpliterator(final Spliterator i) {
	 ...
	 if (i instanceof Spliterator.OfPrimitive) return new PrimitiveSpliteratorWrapper ((Spliterator.OfLong)i);
	...
	public static LongSpliterator asLongSpliterator(final Spliterator i, final LongComparator comparatorOverride) {
	 ...
	 if (i instanceof Spliterator.OfPrimitive) return new PrimitiveSpliteratorWrapperWithComparator ((Spliterator.OfLong)i, comparatorOverride);
	 ...
	 */
	public static void onEachMatching(final LongSpliterator spliterator, final LongPredicate predicate, final LongConsumer action) {
	 ...
	 */
	public static abstract class AbstractIndexBasedSpliterator implements LongSpliterator {
	 ...
	 */
	public static LongSpliterator fromTo(final int from, final int to) {
	...
	private static class SpliteratorConcatenator implements LongSpliterator {
	 ...
	 public LongComparator getComparator() {
	  if (length == 1 && ((characteristics & SORTED) != 0) ) {
	   return (LongComparator) a[offset].getComparator();
	  }
