...
import marcel.util.primitives.iterators.DoubleIterators;
...
public class DoubleOpenHashSet extends AbstractDoubleSet implements java.io.Serializable, Cloneable, Hash {
	...
	public static DoubleOpenHashSet toSet(java.util.stream.DoubleStream stream) {
	 return stream.collect(
	  DoubleOpenHashSet::new,
	  DoubleOpenHashSet::add,
	  DoubleOpenHashSet::addAll);
	}
	...
	public boolean add(final double k) {
	 ...
	 if (( Double.doubleToLongBits(k) == 0 )) {
	  ...
	  // The starting point.
	  if (! ( Double.doubleToLongBits(curr = key[pos = (int)Hash.mix( Double.doubleToRawLongBits(k) ) & mask]) == 0 )) {
	...
	protected final void shiftKeys(int pos) {
	 ...
	 for(;;) {
	  ...
	  for(;;) {
	   ...
	   slot = (int)Hash.mix( Double.doubleToRawLongBits(curr) ) & mask;
	...
	public boolean remove(final double k) {
	 ...
	 int pos;
	 // The starting point.
	 if (( Double.doubleToLongBits(curr = key[pos = (int)Hash.mix( Double.doubleToRawLongBits(k) ) & mask]) == 0 )) return false;
	...
	protected void rehash(final int newN) {
	 ...
	 for(int j = realSize(); j-- != 0;) {
	  ...
	  if (! ( Double.doubleToLongBits(newKey[pos = (int)Hash.mix( Double.doubleToRawLongBits(key[i]) ) & mask]) == 0 ))
	...
	private void readObject(java.io.ObjectInputStream s) throws java.io.IOException, ClassNotFoundException {
	 ...
	 for(int i = size, pos; i-- != 0;) {
	  ...
	  if (( Double.doubleToLongBits(k) == 0 )) {
	   ...
	   if (! ( Double.doubleToLongBits(key[pos = (int)Hash.mix( Double.doubleToRawLongBits(k) ) & mask]) == 0 ))
